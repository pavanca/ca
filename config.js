...
/* ============================================================
   FINAL REBUILD OVERRIDES — LOCKED 2026-08-23
============================================================ */
...
SITE_CONFIG.coverage.heroLine = "Serving clients across India · NRI support";

SITE_CONFIG.hero = {
  ...SITE_CONFIG.hero,
  eyebrow: "CA Expertise · Business Experience · Technology Mindset.",
  title: "A deadline coming up?",
  questions: [
    "A deadline coming up?",
    "Got a notice that's confusing?",
    "Starting something new?",
    "Or just not sure where to begin?"
  ],
  description: "Don't worry. Just tell us what's going on. We'll help you make sense of it and figure out what to do next. Whether it's GST, tax, accounts, finance or your business — we're here to help.",
  supportingText: "Serving clients across India · NRI support",
  primaryAction: { label: "WhatsApp Us", type: "whatsapp" },
  secondaryAction: { label: "Call Us", type: "phone" }
};

SITE_CONFIG.quickAlert = { ...SITE_CONFIG.quickAlert, enabled: false };
SITE_CONFIG.features = {
  ...SITE_CONFIG.features,
  quickAlert: false,
  professionalStory: false,
  digitalOffice: false,
  startHere: false,
...
SITE_CONFIG.sections.services = {
  ...SITE_CONFIG.sections.services,
  eyebrow: "WHAT WE DO",
  title: "Tax, GST, accounts — and everything around them.",
  description: "Tell us what you need help with."
};

SITE_CONFIG.sections.whoWeHelp = {
  eyebrow: "WHO WE HELP",
  title: "From individuals to growing businesses.",
  description: "Whether you're handling your own finances or running an organisation, we're here to help."
};

SITE_CONFIG.sections.industries = {
  eyebrow: "SECTORS WE SUPPORT",
  title: "Different businesses. Same goal. Keeping things sorted.",
  description: ""
};
...
SITE_CONFIG.audiences = [
  ...
  { id: "small-businesses", title: "Small Businesses" },
  { id: "startups", title: "Startups" },
  { id: "growing-businesses", title: "Growing Businesses" },
  { id: "companies", title: "Companies & Corporates" },
  { id: "nris", title: "NRIs" },
  { id: "trusts", title: "Trusts & Societies" },
  { id: "ngos", title: "NGOs" }
];
...
SITE_CONFIG.sections.advantage = {
  ...
  journey: [
    { number: "01", label: "BANKING", company: "ICICI Bank", role: "Bank Manager" },
    { number: "02", label: "BUSINESS & TECHNOLOGY", company: "Infosys", role: "Business Analyst — Finance" },
    { number: "03", label: "CHARTERED ACCOUNTANCY", company: "Pavan Reddy & Co.", role: "CA Practice · Since 2018" }
  ],
  strengths: [
    { title: "Financial Perspective", text: "A practical understanding of finance, numbers and the decisions behind them." },
    { title: "Business Understanding", text: "Looking beyond compliance to better understand what's actually happening in a business." },
    { title: "Technology Advantage", text: "Using the right tools to make everyday work, collaboration and document handling simpler." }
  ],
  closing: "Different experiences. One practical advantage — a broader perspective when helping you make sense of your finances and business."
};
...
SITE_CONFIG.sections.contact = {
  ...
  description: "A deadline coming up? A notice you don't understand? Starting a business? Or simply not sure where to start?",
  reassurance: "Don't worry about finding the right words. Just tell us what's going on.",
  findUsLabel: "FIND US",
...
SITE_CONFIG.footer = {
  ...SITE_CONFIG.footer,
  copyright: "© 2026 Pavan Reddy & Co. All rights reserved."
};
